...
//   // Title typing — sequential lines
//   useEffect(() => {
//     // Line 1
//     let i = 0;
//     const t1 = setInterval(() => {
//       if (i <= LINE1.length) { setTyped1(LINE1.slice(0, i)); i++; }
//       else {
//         clearInterval(t1);
...
//           if (j <= LINE2.length) { setTyped2(LINE2.slice(0, j)); j++; }
//           else {
//             clearInterval(t2);
...
//               if (k <= LINE3.length) { setTyped3(LINE3.slice(0, k)); k++; }
//               else {
//                 clearInterval(t3);
...
//           <span style={{ fontSize: "11px", color: "#336633", letterSpacing: "0.08em" }}>
//             {navText}<span style={{ opacity: tick ? 1 : 0, transition: "opacity 0.1s" }}>█</span>
//           </span>
//         </div>
//         {mounted && (
//           <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
//             <span style={{ fontSize: "11px", color: "#336633" }}>
//               SIM_API: <span style={{ color: "#00FF88" }}>READY</span>
//             </span>
//             <span suppressHydrationWarning style={{ fontSize: "11px", color: "#1a3a1a" }}>{currentTime}</span>
//           </div>
//         )}
//       </nav>
...
//         }}>
//           <div style={{ fontSize: "11px", color: "#1a3a1a", letterSpacing: "0.25em", marginBottom: "20px" }}>
...
//             lineHeight: 1.0,
//             color: "#00FF88",
//             textShadow: isDone ? "0 0 40px rgba(0,255,136,0.3)" : "none",
...
//             lineHeight: 1.0,
//             color: "#00E5FF",
//             textShadow: isDone ? "0 0 40px rgba(0,229,255,0.25)" : "none",
//             transition: "text-shadow 1s ease",
//             minHeight: "1.05em",
//           }}>
...
//         {/* Subtext — fades in after title done */}
//         <p style={{
//           textAlign: "center",
//           fontSize: "14px",
//           color: "#4a7a4a",
...
//         }}>
//           <div style={{ fontSize: "11px", color: "#1a3a1a", letterSpacing: "0.15em", marginBottom: "8px" }}>
...
//           }}>
//             <span style={{ padding: "15px 14px 15px 18px", color: focused ? "#00FF88" : "#336633", fontSize: "14px", flexShrink: 0, transition: "color 0.2s" }}>▶</span>
//             <input
//               type="text"
//               value={address}
...
//             <span style={{ fontSize: "11px", color: "#1a3a1a", letterSpacing: "0.1em" }}>DEMO:</span>
//             {DEMO_WALLETS.map((w) => (
//               <button
//                 key={w.address}
...
//                 onMouseLeave={(e) => { e.currentTarget.style.color = "#336633"; e.currentTarget.style.borderColor = "rgba(0,255,136,0.12)"; e.currentTarget.style.background = "transparent"; }}
//               >
//                 [{w.label}]
//               </button>
//             ))}
...
//               <div style={{ fontSize: "10px", color: "#336633", letterSpacing: "0.1em" }}>{s.label}</div>
//             </div>
//           ))}
//         </div>
...
//         }}>
//           <div style={{ fontSize: "10px", color: "#1a3a1a", letterSpacing: "0.18em", marginBottom: "16px" }}>
//             ── AVAILABLE_MODULES ────────────────────────────────────────────────────────────
//           </div>
//           <div style={{
...
//                   ▸ {f.key}
//                 </div>
//                 <div style={{ fontSize: "12px", color: "#4a7a4a", lineHeight: 1.7, letterSpacing: "0.02em" }}>
//                   {f.desc}
//                 </div>
//               </div>
//             ))}
...
//         <div style={{
//           marginTop: "64px", fontSize: "11px", color: "#1a3a1a",
//           letterSpacing: "0.1em", textAlign: "center",
//           opacity: isDone ? 1 : 0, transition: "opacity 1s ease 0.8s",
//         }}>
...
//         ::placeholder { color: #1a3a1a; font-family: 'Courier New', monospace; font-size: 14px; }
